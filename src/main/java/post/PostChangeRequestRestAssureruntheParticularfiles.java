...
public class PostChangeRequestRestAssureruntheParticularfiles {
	
	/*
	 * run the particular files we need to indices 
	 * to run it parallel add parallel
	 */
	@DataProvider(name="getJsonFiles",indices= {1}/*,parallel=true*/)
